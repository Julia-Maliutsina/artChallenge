...
function pageLoad () {
    if (page=='main') {
        ...
        try {           
            ...
            var tableResults=document.getElementsByClassName('table')[0];
            var resultfield=document.getElementById('RESULT');
            resultfield.offsetParent.removeChild(resultfield);
            resultfield.removeChild(cup);
            resultfield.removeChild(percent);
            resultfield.removeChild(player);
            resultfield.removeChild(tableResults);
        }
        catch(err){};
